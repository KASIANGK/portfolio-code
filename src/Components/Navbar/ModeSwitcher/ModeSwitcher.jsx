...
const ModeSwitcher = () => {
  ...
  return (
    <div className="body">
      ...
      <div onClick={handleToggle} id={isDay ? "day" : "night"} className="switch-button"></div>
      <div id="background"></div>
      ...
      {/* <svg version="1.1" id="darkmode" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
        width="369px" height="171.667px" viewBox="0 0 369 171.667" enableBackground="new 0 0 369 171.667" xmlSpace="preserve">
        <g>
            ...
            <g>
              <g>
                <path fill="#CAD9DD" d="M255.662,153.639c-18.114,0-35.144-7.055-47.952-19.863c-12.808-12.807-19.861-29.837-19.861-47.951
                  s7.054-35.144,19.861-47.951c12.809-12.809,29.838-19.862,47.952-19.862s35.144,7.054,47.951,19.862
                  c12.809,12.808,19.862,29.838,19.862,47.951s-7.054,35.144-19.862,47.951C290.806,146.584,273.776,153.639,255.662,153.639z" />
                <path fill="#A2B5BF" d="M255.662,14.35c-9.646,0-19.007,1.891-27.823,5.62c-8.512,3.6-16.155,8.753-22.717,15.315c-6.563,6.562-11.715,14.204-15.314,22.717c-3.729,8.816-5.62,18.178-5.62,27.823
                  s1.891,19.007,5.62,27.824c3.6,8.512,8.752,16.154,15.314,22.717c6.563,6.563,14.204,11.715,22.717,15.315
                  c8.816,3.729,18.178,5.62,27.823,5.62c10.457,0,20.756-2.047,30.015-6.078c-0.039-0.331-0.053-0.662-0.053-0.989
                  c0-6.618,5.388-12.014,12.014-12.014c6.623,0,12.014,5.396,12.014,12.014c0,0.328-0.014,0.658-0.052,0.987
                  C276.418,145.263,266.12,153.639,255.662,153.639z M255.662,31.674c-14.418,0-27.858,5.603-37.892,15.612c-10.034,10.007-15.592,23.508-15.592,37.786s5.558,27.779,15.592,37.786c10.034,10.007,23.473,15.612,37.892,15.612
                  s27.858-5.603,37.892-15.612c10.034-10.007,15.592-23.508,15.592-37.786S266.637,31.674,255.662,31.674z" />
              </g>
            </g>
          </g>
          <g id="cloud">
            <path fill="#CAD9DD" d="M91.771,102.73c-13.064,0-24.738-10.36-24.738-23.254c0-11.76,8.477-21.524,19.626-23.086
              c2.076-1.398,3.947-3.191,5.447-5.267c-0.308-1.373-0.451-2.771-0.451-4.178c0-6.618,5.388-12.014,12.014-12.014
              c6.623,0,12.014,5.396,12.014,12.014c0,1.398-0.145,2.825-0.45,4.194c1.732,2.232,3.807,4.187,6.096,5.79
              c5.607,3.93,12.187,6.44,19.185,6.44c13.064,0,24.738,10.36,24.738,23.254S104.835,102.73,91.771,102.73z"/>
          </g>
          <g id="sun">
            <path fill="#F1C40F" d="M255.662,31.674c-14.418,0-27.858,5.603-37.892,15.612c-10.034,10.007-15.592,23.508-15.592,37.786
              s5.558,27.779,15.592,37.786c10.034,10.007,23.473,15.612,37.892,15.612s27.858-5.603,37.892-15.612
              c10.034-10.007,15.592-23.508,15.592-37.786S303.588,41.681,293.554,31.674C283.52,21.665,270.08,16.062,255.662,16.062z"/>
          </g>
        </g>
      </svg> */}
    </div>
